...
export const IconOperationsHistory = ({ width = 24, height = 24, className }: { width?: number | string; height?: number | string; className?: string }) => (
  <svg width={width} height={height} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
    <path d="M3 6.75C3 5.7835 3.7835 5 4.75 5H19.25C20.2165 5 21 5.7835 21 6.75V17.25C21 18.2165 20.2165 19 19.25 19H4.75C3.7835 19 3 18.2165 3 17.25V6.75Z" stroke="white" strokeWidth="2" />
    <path d="M7 12H17" stroke="white" strokeWidth="2" strokeLinecap="round" />
    <path d="M7.5 9L6 10.5L7.5 12" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
    <path d="M16.5 12L18 13.5L16.5 15" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
);
